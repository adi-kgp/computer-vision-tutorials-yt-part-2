...
def NMS(boxes, class_ids, confidences, overlapThresh = 0.5):
    ...
    areas = (x2 - x1 + 1) * (y2 - y1 + 1) # we add 1, because the pixel at the start as well as the end counts
    # The indices of all the boxes at start, we will redundant indices one by one
